...
namespace ElevenLabs
{
    public partial class DubbingClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.DubbingResource> GetAsync(
            string dubbingId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ElevenLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Get",
                                methodName: "GetAsync",
                                pathTemplate: "$\"/v1/dubbing/resource/{dubbingId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ElevenLabs.DubbingResource.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ElevenLabs.DubbingResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
