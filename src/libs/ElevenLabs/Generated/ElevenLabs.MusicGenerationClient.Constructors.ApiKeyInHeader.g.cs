...
{
    public sealed partial class MusicGenerationClient
    {
        /// <inheritdoc cref="MusicGenerationClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated MusicGenerationClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static MusicGenerationClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new MusicGenerationClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated MusicGenerationClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out MusicGenerationClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new MusicGenerationClient(
                httpClient,
                baseUri,
                authorizations,
                options,
