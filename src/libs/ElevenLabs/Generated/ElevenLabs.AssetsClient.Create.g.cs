...
namespace ElevenLabs
{
    public partial class AssetsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AssetResponse> CreateAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ElevenLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.AssetResponse>> CreateAsResponseAsync(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            var __contentAsset = new global::System.Net.Http.ByteArrayContent(request.Asset ?? global::System.Array.Empty<byte>());
                            __contentAsset.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.Assetname is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.Assetname) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentAsset,
                                name: "\"asset\"",
                                fileName: request.Assetname != null ? $"\"{request.Assetname}\"" : string.Empty);
                            if (__contentAsset.Headers.ContentDisposition != null)
                            {
                                __contentAsset.Headers.ContentDisposition.FileNameStar = null;
                            }
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ElevenLabs.AssetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.AssetResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ElevenLabs.AssetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AssetResponse> CreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ElevenLabs.BodyUploadAssetV1AssetsPost
            {
                Asset = asset,
                Assetname = assetname,
                Name = name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            asset = asset ?? throw new global::System.ArgumentNullException(nameof(asset));
            var request = new global::ElevenLabs.BodyUploadAssetV1AssetsPost
            {
                Asset = global::System.Array.Empty<byte>(),
                Assetname = assetname,
                Name = name,
            };
            PrepareArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            var __httpRequestContent = new global::System.Net.Http.MultipartFormDataContent();
                            var __contentAsset = new global::System.Net.Http.StreamContent(asset);
                            __contentAsset.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.Assetname is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.Assetname) ?? string.Empty).ToLowerInvariant() switch
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ElevenLabs.AssetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ElevenLabs.AssetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
