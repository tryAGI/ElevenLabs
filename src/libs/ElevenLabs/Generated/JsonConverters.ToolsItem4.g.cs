...
namespace ElevenLabs.JsonConverters
{
    ...
    public class ToolsItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.ToolsItem4>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.PromptAgentDBModelToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.PromptAgentDBModelToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.PromptAgentDBModelToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.WebhookToolConfigInput? webhook = default;
            if (discriminator?.Type == global::ElevenLabs.PromptAgentDBModelToolDiscriminatorType.Webhook)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.PromptAgentDBModelToolDiscriminatorType.Client)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.PromptAgentDBModelToolDiscriminatorType.System)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.PromptAgentDBModelToolDiscriminatorType.Mcp)
            {
