...
{
    public sealed partial class ConversationalAiClient
    {
        /// <inheritdoc cref="ConversationalAiClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated ConversationalAiClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ConversationalAiClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new ConversationalAiClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ConversationalAiClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ConversationalAiClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ConversationalAiClient(
                httpClient,
                baseUri,
                authorizations,
                options,
