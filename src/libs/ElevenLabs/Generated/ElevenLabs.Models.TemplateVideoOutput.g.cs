...
namespace ElevenLabs
{
    ...
    public sealed partial class TemplateVideoOutput
    {
        ...
        public global::ElevenLabs.TemplateVideoOutputFailureReason? FailureReason { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateVideoOutput" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the generation behind this output. Pass it as a `generation` reference to use the output as an input elsewhere.
        /// </param>
...
#endif
        public TemplateVideoOutput(
            string id,
            global::ElevenLabs.TemplateRunStatus status,
            global::ElevenLabs.TemplateVideoOutputFailureReason? failureReason,
            string? errorMessage,
            string? contentUrl,
