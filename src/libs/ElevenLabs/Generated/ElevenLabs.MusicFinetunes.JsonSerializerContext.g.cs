...
namespace ElevenLabs
{
    ...
    public sealed partial class MusicFinetunesSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static MusicFinetunesSourceGenerationContext Default { get; } = new(DefaultOptions);

        private MusicFinetunesSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
