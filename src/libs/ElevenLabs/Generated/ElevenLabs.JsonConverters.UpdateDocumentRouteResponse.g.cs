...
{
    /// <inheritdoc />
    public class UpdateDocumentRouteResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.UpdateDocumentRouteResponse>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.UpdateDocumentRouteResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.UpdateDocumentRouteResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.UpdateDocumentRouteResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.UpdateDocumentRouteResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.GetKnowledgeBaseURLResponseModel? url = default;
            if (discriminator?.Type == global::ElevenLabs.UpdateDocumentRouteResponseDiscriminatorType.Url)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateDocumentRouteResponseDiscriminatorType.File)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateDocumentRouteResponseDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateDocumentRouteResponseDiscriminatorType.Folder)
            {
            ...
            var __value = new global::ElevenLabs.UpdateDocumentRouteResponse(
                discriminator?.Type,
                url,
        ...
        public override void Write(
            ...
            global::ElevenLabs.UpdateDocumentRouteResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
