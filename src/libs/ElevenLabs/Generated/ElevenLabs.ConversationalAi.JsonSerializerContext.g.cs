...
namespace ElevenLabs
{
    ...
    public sealed partial class ConversationalAiSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ConversationalAiSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ConversationalAiSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
