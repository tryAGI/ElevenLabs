...
namespace ElevenLabs
{
    ...
    {
        partial void PrepareCreateProjectsProjectIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string? xiApiKey,
            global::ElevenLabs.BodyEditBasicProjectInfoV1ProjectsProjectIdPost request);
        partial void PrepareCreateProjectsProjectIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string? xiApiKey,
            global::ElevenLabs.BodyEditBasicProjectInfoV1ProjectsProjectIdPost request);
        partial void ProcessCreateProjectsProjectIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateProjectsProjectIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.EditProjectResponseModel> CreateProjectsProjectIdAsync(
            string projectId,
            global::ElevenLabs.BodyEditBasicProjectInfoV1ProjectsProjectIdPost request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: _httpClient);
            PrepareCreateProjectsProjectIdArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareCreateProjectsProjectIdRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessCreateProjectsProjectIdResponse(
                httpClient: _httpClient,
            ...
            ProcessCreateProjectsProjectIdResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateProjectsProjectIdAsync(
                projectId: projectId,
                xiApiKey: xiApiKey,
                request: request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
