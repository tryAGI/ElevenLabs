...
{
    /// <inheritdoc />
    public class ForwardConditionVariant1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.ForwardConditionVariant1>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.ForwardConditionVariant1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.WorkflowUnconditionalModelInput? unconditional = default;
            if (discriminator?.Type == global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1DiscriminatorType.Unconditional)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1DiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1DiscriminatorType.Result)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowEdgeModelInputForwardConditionVariant1DiscriminatorType.Expression)
            {
            ...
            var __value = new global::ElevenLabs.ForwardConditionVariant1(
                discriminator?.Type,
                unconditional,
        ...
        public override void Write(
            ...
            global::ElevenLabs.ForwardConditionVariant1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
