...
{
    /// <inheritdoc />
    public class ChildrenItem3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.ChildrenItem3>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.ChildrenItem3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeInputChildrenItemDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::ElevenLabs.ChildrenItem3(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.ChildrenItem3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
