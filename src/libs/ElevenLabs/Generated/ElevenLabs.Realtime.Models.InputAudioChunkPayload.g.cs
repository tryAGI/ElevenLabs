...
{
    /// <summary>
    /// Audio chunk sent by the client for transcription.
    /// </summary>
    public sealed partial class InputAudioChunkPayload
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::ElevenLabs.Realtime.JsonConverters.InputAudioChunkPayloadMessageTypeJsonConverter))]
        public global::ElevenLabs.Realtime.InputAudioChunkPayloadMessageType MessageType { get; set; }
        ...
        /// <summary>
        /// Whether to commit the audio buffer and produce a final transcript.
        /// </summary>
