...
namespace ElevenLabs.JsonConverters
{
    ...
    public class Left6JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Left6>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.DivOperator)
            {
            ...
            var __value = new global::ElevenLabs.Left6(
                discriminator?.Type,
                stringLiteral,
