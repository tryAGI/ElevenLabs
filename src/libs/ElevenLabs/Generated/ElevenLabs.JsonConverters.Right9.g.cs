...
{
    /// <inheritdoc />
    public class Right9JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Right9>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Right9 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::ElevenLabs.Right9(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Right9 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
