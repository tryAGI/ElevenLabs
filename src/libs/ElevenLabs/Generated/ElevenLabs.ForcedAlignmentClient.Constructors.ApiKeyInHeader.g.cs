...
{
    public sealed partial class ForcedAlignmentClient
    {
        /// <inheritdoc cref="ForcedAlignmentClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated ForcedAlignmentClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ForcedAlignmentClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new ForcedAlignmentClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ForcedAlignmentClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ForcedAlignmentClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ForcedAlignmentClient(
                httpClient,
                baseUri,
                authorizations,
                options,
