...
{
    public sealed partial class MusicFinetunesClient
    {
        /// <inheritdoc cref="MusicFinetunesClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>

        public MusicFinetunesClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated MusicFinetunesClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static MusicFinetunesClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new MusicFinetunesClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated MusicFinetunesClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out MusicFinetunesClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new MusicFinetunesClient(
                httpClient,
                baseUri,
                authorizations,
                options,
