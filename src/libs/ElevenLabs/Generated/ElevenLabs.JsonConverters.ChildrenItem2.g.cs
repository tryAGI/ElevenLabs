...
{
    /// <inheritdoc />
    public class ChildrenItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.ChildrenItem2>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.ChildrenItem2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTAndOperatorNodeOutputChildrenItemDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.ChildrenItem2(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.ChildrenItem2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
