...
namespace ElevenLabs
{
    public partial class WorkspaceClient
    {
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement s_CreateWorkspacesApiKeysThirdPartyDisablingSecurityRequirement0 =
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement[] s_CreateWorkspacesApiKeysThirdPartyDisablingSecurityRequirements =
            new global::ElevenLabs.EndPointSecurityRequirement[]
            {                s_CreateWorkspacesApiKeysThirdPartyDisablingSecurityRequirement0,
            };
        partial void PrepareCreateWorkspacesApiKeysThirdPartyDisablingArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ElevenLabs.BodySetWorkspaceThirdPartyDisablingPolicyV1WorkspacesApiKeysThirdPartyDisablingPost request);
        partial void PrepareCreateWorkspacesApiKeysThirdPartyDisablingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ElevenLabs.BodySetWorkspaceThirdPartyDisablingPolicyV1WorkspacesApiKeysThirdPartyDisablingPost request);
        partial void ProcessCreateWorkspacesApiKeysThirdPartyDisablingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWorkspacesApiKeysThirdPartyDisablingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateWorkspacesApiKeysThirdPartyDisablingAsync(

            global::ElevenLabs.BodySetWorkspaceThirdPartyDisablingPolicyV1WorkspacesApiKeysThirdPartyDisablingPost request,
            global::ElevenLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateWorkspacesApiKeysThirdPartyDisablingAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ElevenLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AutoSDKHttpResponse<string>> CreateWorkspacesApiKeysThirdPartyDisablingAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWorkspacesApiKeysThirdPartyDisablingArguments(
            ...
            var __authorizations = global::ElevenLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateWorkspacesApiKeysThirdPartyDisablingSecurityRequirements,
                operationName: "CreateWorkspacesApiKeysThirdPartyDisablingAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ElevenLabs.PathBuilder(
                                path: "/v1/workspaces/api-keys/third-party-disabling",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateWorkspacesApiKeysThirdPartyDisablingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ElevenLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createWorkspacesApiKeysThirdPartyDisabling",
                                methodName: "CreateWorkspacesApiKeysThirdPartyDisablingAsync",
                                pathTemplate: "\"/v1/workspaces/api-keys/third-party-disabling\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWorkspacesApiKeysThirdPartyDisablingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWorkspacesApiKeysThirdPartyDisablingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateWorkspacesApiKeysThirdPartyDisablingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ElevenLabs.BodySetWorkspaceThirdPartyDisablingPolicyV1WorkspacesApiKeysThirdPartyDisablingPost
            {
                ThirdPartyDisableAllowed = thirdPartyDisableAllowed,
            };

            return await CreateWorkspacesApiKeysThirdPartyDisablingAsync(
                request: __request,
                requestOptions: requestOptions,
