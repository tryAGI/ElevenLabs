...
namespace ElevenLabs
{
    public partial class ProductionsClient
    {
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement s_RegisterSecurityRequirement0 =
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement[] s_RegisterSecurityRequirements =
            new global::ElevenLabs.EndPointSecurityRequirement[]
            {                s_RegisterSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::ElevenLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RegisterSecurityRequirements,
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.MediaUrl != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.MediaUrl ?? string.Empty),
                                    name: "\"media_url\"");

                            }
                            if (request.MediaUrlFilename != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.MediaUrlFilename ?? string.Empty),
                                    name: "\"media_url_filename\"");

                            }
                            if (request.MediaUrlContentType != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.MediaUrlContentType ?? string.Empty),
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ElevenLabs.RegisterMediaResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.RegisterMediaResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ElevenLabs.RegisterMediaResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ElevenLabs.BodyRegisterMediaV1ProductionsOrdersOrderIdMediaPost
            {
                ...
                Medianame = medianame,
                MediaUrl = mediaUrl,
                MediaUrlFilename = mediaUrlFilename,
                MediaUrlContentType = mediaUrlContentType,
            };
