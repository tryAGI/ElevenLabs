...
{
    /// <inheritdoc />
    public class ChildrenItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.ChildrenItem4>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.ChildrenItem4 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.ChildrenItem4(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.ChildrenItem4 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
