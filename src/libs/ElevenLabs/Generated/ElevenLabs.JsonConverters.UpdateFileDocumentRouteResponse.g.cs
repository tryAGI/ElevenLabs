...
{
    /// <inheritdoc />
    public class UpdateFileDocumentRouteResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.UpdateFileDocumentRouteResponse>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.UpdateFileDocumentRouteResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.GetKnowledgeBaseURLResponseModel? url = default;
            if (discriminator?.Type == global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminatorType.Url)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminatorType.File)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.UpdateFileDocumentRouteResponseDiscriminatorType.Folder)
            {
            ...
            var __value = new global::ElevenLabs.UpdateFileDocumentRouteResponse(
                discriminator?.Type,
                url,
        ...
        public override void Write(
            ...
            global::ElevenLabs.UpdateFileDocumentRouteResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
