...
namespace ElevenLabs.JsonConverters
{
    ...
    public class DependentAgentsItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.DependentAgentsItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.GetKnowledgeBaseSummaryResponseModelDependentAgentDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.GetKnowledgeBaseSummaryResponseModelDependentAgentDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.GetKnowledgeBaseSummaryResponseModelDependentAgentDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.DependentAvailableAgentIdentifier? available = default;
            if (discriminator?.Type == global::ElevenLabs.GetKnowledgeBaseSummaryResponseModelDependentAgentDiscriminatorType.Available)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.GetKnowledgeBaseSummaryResponseModelDependentAgentDiscriminatorType.Unknown)
            {
            ...
            var result = new global::ElevenLabs.DependentAgentsItem(
                discriminator?.Type,
                available,
                unknown
                );
