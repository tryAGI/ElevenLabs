...
{
    /// <summary>
    /// Stream expressive dialogue audio over a WebSocket by sending incremental text segments per registered voice.<br/>
    ...
    /// ## Session setup<br/>
    /// - After connecting, the first JSON message **must** include `voices` (voice IDs to register for the session) and credentials if not already sent via headers or query string.<br/>
    /// - Optional `voice_settings` and `pronunciation_dictionary_locators` are only accepted on the first message.<br/>
    /// - For `eleven_v3_conversational`, only **one** voice ID may be registered. For `eleven_v3`, you may register up to **10** voices.<br/>
    /// ## Streaming text<br/>
    /// - Send `inputs`: an array of `{ "text", "voice_id", "new_turn"? }`. Text for the same turn is buffered until the server has enough context (at least ~40 characters and 8 words), then partial audio chunks are emitted.<br/>
    /// - Set `new_turn` to `true` (or switch `voice_id`) to finalize the current prosody segment and start a new speaker turn.<br/>
    /// ## Control messages<br/>
    /// - `flush`: force generation of any buffered text without closing the socket.<br/>
    /// - `close_socket`: flush remaining audio, send a final message, and close the connection.<br/>
    /// - `keep_alive`: reset the **20 second** receive timeout (no generation).<br/>
    /// ## Authentication<br/>
    /// Use the `xi-api-key` or `Authorization` header, `single_use_token` query parameter, or include `xi_api_key`, `authorization`, or `single_use_token` in the first message body (same pattern as [Text to Speech WebSocket](/docs/api-reference/text-to-speech/v-1-text-to-speech-voice-id-stream-input)). Anonymous sessions are rejected.<br/>
    ...
    /// </summary>
    public sealed partial class TextToDialogueRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        /// <summary>
        /// Default WebSocket base URL.
        /// </summary>
        public const string DefaultBaseUrl = "wss://api.elevenlabs.io/v1/text-to-dialogue/stream-input";
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.ServerEvent>>? MessageReceived;
        /// <summary>
        /// Raised after a audioChunk message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketAudioChunk>>? AudioChunkReceived;
        /// <summary>
        /// Raised after a finalAudioForTurn message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketFinalAudioForTurn>>? FinalAudioForTurnReceived;
        /// <summary>
        /// Raised after a final message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketFinal>>? FinalReceived;
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the TextToDialogueRealtimeClient.
        ...
        public TextToDialogueRealtimeClient(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                var __pathBuilder = new global::ElevenLabs.TextToDialogueRealtime.PathBuilder(
                    path: DefaultBaseUrl);
