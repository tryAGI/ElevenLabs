    ...
    public static class ModelIDExtensions
    {
        ...
        public static string ToValueString(this ModelID value)
        {
            return value switch
            {
                ...
                ModelID.ElevenDubbingE2eV1 => "eleven_dubbing_e2e_v1",
                ModelID.ElevenMultilingualV2 => "eleven_multilingual_v2",
                ModelID.ElevenMusicV1 => "eleven_music_v1",
                ModelID.ElevenMusicV2 => "eleven_music_v2",
                ModelID.ElevenScribeV1 => "eleven_scribe_v1",
                ...
                ModelID.Gemini31ProPreviewLlm => "gemini-3.1-pro-preview-llm",
                ModelID.Gemini35FlashLlm => "gemini-3.5-flash-llm",
                ModelID.GptImage1 => "gpt-image-1",
                ModelID.GptImage15 => "gpt-image-1.5",
                ModelID.GptImage2 => "gpt-image-2",
                ModelID.HeygenAvatar4 => "heygen-avatar4",
                ...
                ModelID.KlingO3EditVideo => "kling-o3-edit-video",
                ...
                ModelID.Krea2Large => "krea-2-large",
                ModelID.Krea2Medium => "krea-2-medium",
        ...
        public static ModelID? ToEnum(string value)
        {
            return value switch
            {
                ...
                "eleven_dubbing_e2e_v1" => ModelID.ElevenDubbingE2eV1,
                "eleven_multilingual_v2" => ModelID.ElevenMultilingualV2,
                "eleven_music_v1" => ModelID.ElevenMusicV1,
                "eleven_music_v2" => ModelID.ElevenMusicV2,
                "eleven_scribe_v1" => ModelID.ElevenScribeV1,
                ...
                "gemini-3.1-pro-preview-llm" => ModelID.Gemini31ProPreviewLlm,
                "gemini-3.5-flash-llm" => ModelID.Gemini35FlashLlm,
                "gpt-image-1" => ModelID.GptImage1,
                "gpt-image-1.5" => ModelID.GptImage15,
                "gpt-image-2" => ModelID.GptImage2,
                "heygen-avatar4" => ModelID.HeygenAvatar4,
                ...
                "kling-o3-edit-video" => ModelID.KlingO3EditVideo,
                ...
                "krea-2-large" => ModelID.Krea2Large,
                "krea-2-medium" => ModelID.Krea2Medium,
