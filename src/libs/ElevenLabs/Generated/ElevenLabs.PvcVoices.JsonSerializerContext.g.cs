...
namespace ElevenLabs
{
    ...
    public sealed partial class PvcVoicesSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static PvcVoicesSourceGenerationContext Default { get; } = new(DefaultOptions);

        private PvcVoicesSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
