...
namespace ElevenLabs
{
    ...
    public sealed partial class BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost" /> class.
        /// </summary>
        /// <param name="prompt">
        /// A simple text prompt to generate a song from. Cannot be used in conjunction with `composition_plan`.
        /// </param>
...
#endif
        public BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost(
            string? prompt,
