...
{
    /// <inheritdoc />
    public class Right6JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Right6>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Right6 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputRightDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputRightDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputRightDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeOutputRightDiscriminatorType.DivOperator)
            {
        ...
        public override void Write(
            ...
            global::ElevenLabs.Right6 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
