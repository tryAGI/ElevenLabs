...
{
    /// <inheritdoc />
    public class McpServersItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.McpServersItem2>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.McpServersItem2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ConvAIStoredSecretDependenciesMcpServerDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ConvAIStoredSecretDependenciesMcpServerDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ConvAIStoredSecretDependenciesMcpServerDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.DependentAvailableMCPServerIdentifier? available = default;
            if (discriminator?.Type == global::ElevenLabs.ConvAIStoredSecretDependenciesMcpServerDiscriminatorType.Available)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ConvAIStoredSecretDependenciesMcpServerDiscriminatorType.Unknown)
            {
            ...
            var __value = new global::ElevenLabs.McpServersItem2(
                discriminator?.Type,
                available,
        ...
        public override void Write(
            ...
            global::ElevenLabs.McpServersItem2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
