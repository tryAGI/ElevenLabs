...
namespace ElevenLabs
{
    public partial class TextToVoice2Client
    {
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.VoiceResponseModel> CreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::ElevenLabs.VoiceResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::ElevenLabs.VoiceResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
