...
namespace ElevenLabs.TextToDialogueMultiContextRealtime
{
    public sealed partial class TextToDialogueMultiContextRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::ElevenLabs.TextToDialogueMultiContextRealtime.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::ElevenLabs.TextToDialogueMultiContextRealtime.ServerEvent @event;
                    try
                    {
                        @event = (global::ElevenLabs.TextToDialogueMultiContextRealtime.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::ElevenLabs.TextToDialogueMultiContextRealtime.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueMultiContextRealtime.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.TextToDialogueWebsocketAudioChunkMulti is { } __AudioChunkMultiReceived)
            {
                AudioChunkMultiReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueMultiContextRealtime.TextToDialogueWebsocketAudioChunkMulti>(
                        __AudioChunkMultiReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketFinalAudioForTurnMulti is { } __FinalAudioForTurnMultiReceived)
            {
                FinalAudioForTurnMultiReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueMultiContextRealtime.TextToDialogueWebsocketFinalAudioForTurnMulti>(
                        __FinalAudioForTurnMultiReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketFinalMulti is { } __FinalMultiReceived)
            {
                FinalMultiReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueMultiContextRealtime.TextToDialogueWebsocketFinalMulti>(
                        __FinalMultiReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketError is { } __ErrorReceived)
            {
                ErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueMultiContextRealtime.TextToDialogueWebsocketError>(
                        __ErrorReceived,
                        rawText,
                        json));
            }
