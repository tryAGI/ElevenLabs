...
{
    /// <inheritdoc />
    public class RightJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Right>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Right Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputRightDiscriminatorType.LteOperator)
            {
            ...
            var result = new global::ElevenLabs.Right(
                discriminator?.Type,
                stringLiteral,
                numberLiteral,
                booleanLiteral,
