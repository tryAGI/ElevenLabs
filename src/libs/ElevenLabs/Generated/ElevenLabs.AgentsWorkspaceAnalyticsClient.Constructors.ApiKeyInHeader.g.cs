...
{
    public sealed partial class AgentsWorkspaceAnalyticsClient
    {
        /// <inheritdoc cref="AgentsWorkspaceAnalyticsClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>

        public AgentsWorkspaceAnalyticsClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated AgentsWorkspaceAnalyticsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static AgentsWorkspaceAnalyticsClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            if (credentialValue is null)
            {
                throw new global::System.InvalidOperationException(
                    "No non-empty credential environment variable value was found. Checked: ELEVENLABS_API_KEY.");
            }
            ...
            var client = new AgentsWorkspaceAnalyticsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated AgentsWorkspaceAnalyticsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out AgentsWorkspaceAnalyticsClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new AgentsWorkspaceAnalyticsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
