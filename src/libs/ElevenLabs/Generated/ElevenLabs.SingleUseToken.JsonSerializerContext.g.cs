...
namespace ElevenLabs
{
    ...
    public sealed partial class SingleUseTokenSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static SingleUseTokenSourceGenerationContext Default { get; } = new(DefaultOptions);

        private SingleUseTokenSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
