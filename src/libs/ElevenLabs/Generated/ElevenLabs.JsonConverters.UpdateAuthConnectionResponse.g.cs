...
{
    /// <inheritdoc />
    public class UpdateAuthConnectionResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.UpdateAuthConnectionResponse>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.UpdateAuthConnectionResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.UpdateAuthConnectionResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.UpdateAuthConnectionResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.UpdateAuthConnectionResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.OAuth2ClientCredsResponse? oauth2ClientCredentials = default;
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.Oauth2ClientCredentials)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.RefreshTokenAuth)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.BasicAuth)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.BearerAuth)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.Oauth2Jwt)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.PrivateKeyJwt)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.Mtls)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.CustomHeaderAuth)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.ApiIntegrationOauth2AuthCode)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.ApiIntegrationOauth2CustomApp)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.WhatsappAuth)
            {
            ...
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.SlackBotAuth)
            {
            ...
            global::ElevenLabs.UrlSecretAuthResponse? urlSecret = default;
            if (discriminator?.AuthType == global::ElevenLabs.UpdateAuthConnectionResponseDiscriminatorAuthType.UrlSecret)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.UrlSecretAuthResponse), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.UrlSecretAuthResponse> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.UrlSecretAuthResponse)}");
                urlSecret = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }

            var __value = new global::ElevenLabs.UpdateAuthConnectionResponse(
        ...
        public override void Write(
            ...
            global::ElevenLabs.UpdateAuthConnectionResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsUrlSecret)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.UrlSecretAuthResponse), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.UrlSecretAuthResponse?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::ElevenLabs.UrlSecretAuthResponse).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.UrlSecret!, typeInfo);
            }
        }
    }
}