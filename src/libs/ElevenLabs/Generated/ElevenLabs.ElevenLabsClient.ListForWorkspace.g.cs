...
namespace ElevenLabs
{
    public partial class ElevenLabsClient
    {
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement s_ListForWorkspaceSecurityRequirement0 =
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement[] s_ListForWorkspaceSecurityRequirements =
            new global::ElevenLabs.EndPointSecurityRequirement[]
            {                s_ListForWorkspaceSecurityRequirement0,
            };
        ...
        partial void ProcessListForWorkspaceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::ElevenLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListForWorkspaceSecurityRequirements,
                operationName: "ListForWorkspaceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListForWorkspaceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ElevenLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListForWorkspace",
                                methodName: "ListForWorkspaceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListForWorkspaceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListForWorkspaceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
