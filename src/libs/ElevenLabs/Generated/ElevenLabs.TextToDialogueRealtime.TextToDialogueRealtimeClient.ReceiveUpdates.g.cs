...
namespace ElevenLabs.TextToDialogueRealtime
{
    public sealed partial class TextToDialogueRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::ElevenLabs.TextToDialogueRealtime.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::ElevenLabs.TextToDialogueRealtime.ServerEvent @event;
                    try
                    {
                        @event = (global::ElevenLabs.TextToDialogueRealtime.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::ElevenLabs.TextToDialogueRealtime.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.TextToDialogueWebsocketAudioChunk is { } __AudioChunkReceived)
            {
                AudioChunkReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketAudioChunk>(
                        __AudioChunkReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketFinalAudioForTurn is { } __FinalAudioForTurnReceived)
            {
                FinalAudioForTurnReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketFinalAudioForTurn>(
                        __FinalAudioForTurnReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketFinal is { } __FinalReceived)
            {
                FinalReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketFinal>(
                        __FinalReceived,
                        rawText,
                        json));
            }
            if (@event.TextToDialogueWebsocketError is { } __ErrorReceived)
            {
                ErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::ElevenLabs.TextToDialogueRealtime.TextToDialogueWebsocketError>(
                        __ErrorReceived,
                        rawText,
                        json));
            }
