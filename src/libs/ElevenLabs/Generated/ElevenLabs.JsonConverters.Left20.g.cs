...
{
    /// <inheritdoc />
    public class Left20JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Left20>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Left20 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputLeftDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.Left20(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Left20 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
