...
{
    /// <inheritdoc />
    public class FalseExpression2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.FalseExpression2>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.FalseExpression2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTConditionalOperatorNodeOutputFalseExpressionDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.FalseExpression2(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.FalseExpression2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
