...
namespace ElevenLabs
{
    ...
    public sealed partial class SourceSegmentUpdateResponse
    {
        ...
        public required global::ElevenLabs.TranscriptSegment Segment { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceSegmentUpdateResponse" /> class.
        /// </summary>
        /// <param name="segment">
        /// The segment in its updated state.
        /// </param>
...
#endif
        public SourceSegmentUpdateResponse(
            global::ElevenLabs.TranscriptSegment segment,
            int revision)
        {
