...
{
    /// <inheritdoc />
    public class DependentAgentsItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.DependentAgentsItem4>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.DependentAgentsItem4 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var result = new global::ElevenLabs.DependentAgentsItem4(
                discriminator?.Type,
                available,
                unknown
                );
        ...
        public override void Write(
            ...
            global::ElevenLabs.DependentAgentsItem4 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
