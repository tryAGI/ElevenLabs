...
{
    /// <inheritdoc />
    public class DependentAgentsItem5JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.DependentAgentsItem5>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.DependentAgentsItem5 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.MCPServerResponseModelDependentAgentDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.MCPServerResponseModelDependentAgentDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.MCPServerResponseModelDependentAgentDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.DependentAvailableAgentIdentifier? available = default;
            if (discriminator?.Type == global::ElevenLabs.MCPServerResponseModelDependentAgentDiscriminatorType.Available)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.MCPServerResponseModelDependentAgentDiscriminatorType.Unknown)
            {
            ...
            var __value = new global::ElevenLabs.DependentAgentsItem5(
                discriminator?.Type,
                available,
        ...
        public override void Write(
            ...
            global::ElevenLabs.DependentAgentsItem5 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
