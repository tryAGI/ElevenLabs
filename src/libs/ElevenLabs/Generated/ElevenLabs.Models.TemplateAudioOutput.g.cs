...
namespace ElevenLabs
{
    ...
    public sealed partial class TemplateAudioOutput
    {
        ...
        public global::ElevenLabs.TemplateAudioOutputFailureReason? FailureReason { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateAudioOutput" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the generation behind this output. Pass it as a `generation` reference to use the output as an input elsewhere.
        /// </param>
...
#endif
        public TemplateAudioOutput(
            string id,
            global::ElevenLabs.TemplateRunStatus status,
            global::ElevenLabs.TemplateAudioOutputFailureReason? failureReason,
            string? errorMessage,
            string? contentUrl,
