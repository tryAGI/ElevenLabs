...
{
    /// <inheritdoc />
    public class InputOverridesVariant1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.InputOverridesVariant1>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.InputOverridesVariant1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ConstantSchemaOverride? constant = default;
            if (discriminator?.Source == global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminatorSource.Constant)
            {
            ...
            if (discriminator?.Source == global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminatorSource.DynamicVariable)
            {
            ...
            if (discriminator?.Source == global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminatorSource.Llm)
            {
            ...
            if (discriminator?.Source == global::ElevenLabs.MCPToolConfigInputInputOverridesDiscriminatorSource.Omit)
            {
            ...
            var __value = new global::ElevenLabs.InputOverridesVariant1(
        ...
        public override void Write(
            ...
            global::ElevenLabs.InputOverridesVariant1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
