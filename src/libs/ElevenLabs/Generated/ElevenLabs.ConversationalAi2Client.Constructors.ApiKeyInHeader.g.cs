...
{
    public sealed partial class ConversationalAi2Client
    {
        /// <inheritdoc cref="ConversationalAi2Client(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::ElevenLabs.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated ConversationalAi2Client by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ConversationalAi2Client CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new ConversationalAi2Client(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ConversationalAi2Client by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ConversationalAi2Client? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::ElevenLabs.EndPointAuthorization>? authorizations = null,
            global::ElevenLabs.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ConversationalAi2Client(
                httpClient,
                baseUri,
                authorizations,
                options,
