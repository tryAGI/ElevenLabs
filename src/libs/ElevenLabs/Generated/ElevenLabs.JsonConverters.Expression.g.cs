...
{
    /// <inheritdoc />
    public class ExpressionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Expression>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Expression Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelInputExpressionDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::ElevenLabs.Expression(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Expression value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
