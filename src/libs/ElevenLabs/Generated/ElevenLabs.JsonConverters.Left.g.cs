...
{
    /// <inheritdoc />
    public class LeftJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Left>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Left Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTEqualsOperatorNodeInputLeftDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::ElevenLabs.Left(
                discriminator?.Type,
                stringLiteral,
