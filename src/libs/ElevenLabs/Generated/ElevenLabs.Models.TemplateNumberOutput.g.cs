...
namespace ElevenLabs
{
    ...
    public sealed partial class TemplateNumberOutput
    {
        ...
        public global::ElevenLabs.TemplateNumberOutputFailureReason? FailureReason { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateNumberOutput" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the generation behind this output. Pass it as a `generation` reference to use the output as an input elsewhere.
        /// </param>
...
#endif
        public TemplateNumberOutput(
            string id,
            global::ElevenLabs.TemplateRunStatus status,
            global::ElevenLabs.TemplateNumberOutputFailureReason? failureReason,
            string? errorMessage,
            double? content,
            string type = "number")
        {
