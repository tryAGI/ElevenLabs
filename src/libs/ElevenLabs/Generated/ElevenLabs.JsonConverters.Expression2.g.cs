...
{
    /// <inheritdoc />
    public class Expression2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Expression2>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Expression2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.Expression2(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Expression2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
