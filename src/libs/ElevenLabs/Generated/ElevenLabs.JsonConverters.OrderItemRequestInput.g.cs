...
{
    /// <inheritdoc />
    public class OrderItemRequestInputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.OrderItemRequestInput>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.OrderItemRequestInput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.OrderItemRequestInputDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.OrderItemRequestInputDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.OrderItemRequestInputDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.DubOrderItemRequest? dub = default;
            if (discriminator?.Kind == global::ElevenLabs.OrderItemRequestInputDiscriminatorKind.Dub)
            {
            ...
            if (discriminator?.Kind == global::ElevenLabs.OrderItemRequestInputDiscriminatorKind.Subtitles)
            {
            ...
            if (discriminator?.Kind == global::ElevenLabs.OrderItemRequestInputDiscriminatorKind.Transcription)
            {
            ...
            var __value = new global::ElevenLabs.OrderItemRequestInput(
                discriminator?.Kind,
                dub,
        ...
        public override void Write(
            ...
            global::ElevenLabs.OrderItemRequestInput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
