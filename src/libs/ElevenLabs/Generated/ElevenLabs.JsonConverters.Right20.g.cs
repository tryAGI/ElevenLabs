...
{
    /// <inheritdoc />
    public class Right20JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Right20>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Right20 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.LteOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.AddOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.SubOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.MulOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.DivOperator)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.ASTSubtractionOperatorNodeOutputRightDiscriminatorType.ConditionalOperator)
            {
            ...
            var __value = new global::ElevenLabs.Right20(
                discriminator?.Type,
                stringLiteral,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Right20 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
