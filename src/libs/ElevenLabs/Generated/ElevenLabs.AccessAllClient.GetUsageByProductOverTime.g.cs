...
namespace ElevenLabs
{
    public partial class AccessAllClient
    {
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement s_GetUsageByProductOverTimeSecurityRequirement0 =
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement[] s_GetUsageByProductOverTimeSecurityRequirements =
            new global::ElevenLabs.EndPointSecurityRequirement[]
            {                s_GetUsageByProductOverTimeSecurityRequirement0,
            };
        ...
        partial void ProcessGetUsageByProductOverTimeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetUsageByProductOverTimeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ElevenLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.WorkspaceAnalyticsQueryResponseModel>> GetUsageByProductOverTimeAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetUsageByProductOverTimeArguments(
            ...
            var __authorizations = global::ElevenLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUsageByProductOverTimeSecurityRequirements,
                operationName: "GetUsageByProductOverTimeAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUsageByProductOverTimeRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ElevenLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUsageByProductOverTime",
                                methodName: "GetUsageByProductOverTimeAsync",
                                pathTemplate: "\"/v1/workspace/analytics/query/usage-by-product-over-time\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUsageByProductOverTimeResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUsageByProductOverTimeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        /// <param name="timeZone">
        /// IANA time zone identifier (e.g. 'America/New_York', 'Europe/London', 'UTC') used to align bucket boundaries for eligible `interval_seconds` values. Week multiples (e.g. 604800) are calendar weeks that start Monday at local midnight. Whole-day multiples that are not whole weeks start at local midnight; whole-hour multiples up to 24 hours align to local hour boundaries from midnight. Sub-hour intervals and other bucket sizes remain UTC-anchored regardless of this setting. Defaults to UTC.<br/>
        /// Default Value: UTC
        /// </param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GetUsageByProductOverTimeAsync(
                request: __request,
                requestOptions: requestOptions,
