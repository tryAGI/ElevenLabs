...
namespace ElevenLabs
{
    ...
    public sealed partial class ConversationConfigInput
    {
        ...
        public global::ElevenLabs.FileInputConfig? FileInput { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationConfigInput" /> class.
        /// </summary>
        /// <param name="textOnly">
        /// If enabled audio will not be processed and only text will be used, use to avoid audio pricing.<br/>
        /// Default Value: false
...
#endif
        public ConversationConfigInput(
            bool? textOnly,
