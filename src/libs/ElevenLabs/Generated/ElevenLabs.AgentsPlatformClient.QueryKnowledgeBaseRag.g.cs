...
namespace ElevenLabs
{
    public partial class AgentsPlatformClient
    {
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement s_QueryKnowledgeBaseRagSecurityRequirement0 =
        ...
        private static readonly global::ElevenLabs.EndPointSecurityRequirement[] s_QueryKnowledgeBaseRagSecurityRequirements =
            new global::ElevenLabs.EndPointSecurityRequirement[]
            {                s_QueryKnowledgeBaseRagSecurityRequirement0,
            };
        partial void PrepareQueryKnowledgeBaseRagArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId,
            ref string? branchId,
            global::ElevenLabs.AgentKnowledgeBaseRagQueryRequestModel request);
        partial void PrepareQueryKnowledgeBaseRagRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId,
            string? branchId,
            global::ElevenLabs.AgentKnowledgeBaseRagQueryRequestModel request);
        partial void ProcessQueryKnowledgeBaseRagResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryKnowledgeBaseRagResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel> QueryKnowledgeBaseRagAsync(
            string agentId,
        ...
        {
            var __response = await QueryKnowledgeBaseRagAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ElevenLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel>> QueryKnowledgeBaseRagAsResponseAsync(
            string agentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueryKnowledgeBaseRagArguments(
            ...
            var __authorizations = global::ElevenLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryKnowledgeBaseRagSecurityRequirements,
                operationName: "QueryKnowledgeBaseRagAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ElevenLabs.PathBuilder(
                                path: $"/v1/convai/agents/{agentId}/knowledge-base/rag-query",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQueryKnowledgeBaseRagRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ElevenLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QueryKnowledgeBaseRag",
                                methodName: "QueryKnowledgeBaseRagAsync",
                                pathTemplate: "$\"/v1/convai/agents/{agentId}/knowledge-base/rag-query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryKnowledgeBaseRagResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ElevenLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryKnowledgeBaseRagResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ElevenLabs.AutoSDKHttpResponse<global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ElevenLabs.AgentKnowledgeBaseRagQueryResponseModel> QueryKnowledgeBaseRagAsync(
            ...
            int? maxDocumentsLength = default,
            int? maxRetrievedRagChunksCount = default,
            global::ElevenLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ElevenLabs.AgentKnowledgeBaseRagQueryRequestModel
            {
                Query = query,
                UseAgentDefaults = useAgentDefaults,
                MaxDocumentsLength = maxDocumentsLength,
                MaxRetrievedRagChunksCount = maxRetrievedRagChunksCount,
            };

            return await QueryKnowledgeBaseRagAsync(
                agentId: agentId,
                branchId: branchId,
                request: __request,
                requestOptions: requestOptions,
