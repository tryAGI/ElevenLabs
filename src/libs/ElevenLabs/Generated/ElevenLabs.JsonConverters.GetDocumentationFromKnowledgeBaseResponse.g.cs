...
{
    /// <inheritdoc />
    public class GetDocumentationFromKnowledgeBaseResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponse>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.GetKnowledgeBaseURLResponseModel? url = default;
            if (discriminator?.Type == global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminatorType.Url)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminatorType.File)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponseDiscriminatorType.Folder)
            {
            ...
            var __value = new global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponse(
                discriminator?.Type,
                url,
        ...
        public override void Write(
            ...
            global::ElevenLabs.GetDocumentationFromKnowledgeBaseResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
