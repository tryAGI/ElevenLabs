...
{
    /// <inheritdoc />
    public class DocumentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ElevenLabs.Document>
    {
        /// <inheritdoc />
        public override global::ElevenLabs.Document Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::ElevenLabs.GetKnowledgeBaseSummaryURLResponseModel? url = default;
            if (discriminator?.Type == global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminatorType.Url)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminatorType.File)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::ElevenLabs.KnowledgeBaseContentSearchResultDocumentDiscriminatorType.Folder)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel)}");
                folder = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }

            var __value = new global::ElevenLabs.Document(
                discriminator?.Type,
                url,
        ...
        public override void Write(
            ...
            global::ElevenLabs.Document value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::ElevenLabs.GetKnowledgeBaseSummaryFolderResponseModel).Name}");
