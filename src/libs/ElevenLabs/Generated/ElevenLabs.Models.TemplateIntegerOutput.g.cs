...
namespace ElevenLabs
{
    ...
    public sealed partial class TemplateIntegerOutput
    {
        ...
        public global::ElevenLabs.TemplateIntegerOutputFailureReason? FailureReason { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateIntegerOutput" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the generation behind this output. Pass it as a `generation` reference to use the output as an input elsewhere.
        /// </param>
...
#endif
        public TemplateIntegerOutput(
            string id,
            global::ElevenLabs.TemplateRunStatus status,
            global::ElevenLabs.TemplateIntegerOutputFailureReason? failureReason,
            string? errorMessage,
            int? content,
            string type = "integer")
        {
