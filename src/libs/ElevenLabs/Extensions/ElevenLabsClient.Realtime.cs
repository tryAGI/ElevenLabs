...
public sealed partial class ElevenLabsClient
{
    ...
    /// Convenience method that delegates to <see cref="SpeechToText2Client.ConnectRealtimeAsync"/>.
    /// </summary>
    ...
    public Task<RealtimeSpeechToTextSession> ConnectRealtimeAsync(
        ...
        => SpeechToText2.ConnectRealtimeAsync(options, connectTimeout, keepAliveInterval, cancellationToken);
}
